...
See [README.md](README.md) for setup, [docs/STUDY-GUIDE.md](docs/STUDY-GUIDE.md) for the study/defense guide and config reference, and [docs/superpowers/specs/](docs/superpowers/specs/) for the design rationale.
